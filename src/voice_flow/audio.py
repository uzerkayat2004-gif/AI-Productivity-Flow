    ...
    def start(self, device: str | int | None = None) -> bool:
        ...
        with self._lifecycle_lock:
            ...
            try:
                ...
                self._native_sr, self._native_ch = 44100, 1

            kwargs = {"samplerate": self._native_sr, "channels": self._native_ch, "dtype": "float32", "blocksize": 1024, "callback": self._audio_callback}
